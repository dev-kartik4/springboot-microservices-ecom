...
public class MerchantKafkaProducerService {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(MerchantKafkaProducerService.class);

    private final KafkaTemplate<String, String> kafkaTemplate;

    @Autowired
    public MerchantKafkaProducerService(KafkaTemplate<String, String> kafkaTemplate) {
